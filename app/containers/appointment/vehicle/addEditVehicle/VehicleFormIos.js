...
class VehicleFormIos extends React.Component {
    ...
    _fetchMakeModel = (year) => {
        ...
        this.setState(() => {
            ...
            this.props.dispatch(change('addEditVehicleForm', 'year', year));
        });
    }
        ...
        this.setState(() => {
            ...
            this.props.makeModel.data.map((make, i) => {
                if (make.make_name.toString() === makeName.toString()) {
                    ...
                    this.props.dispatch(change('addEditVehicleForm', 'make_id', make.make_id));
                }
            });
        });
    }
    ...
    _colorChanged(selectedColor) {
        this.props.vehicleData.color.map((color, i) => {
            if (color.color.toString() === selectedColor.toString()) {
                ...
                this.props.dispatch(change('addEditVehicleForm', 'color_id', color.id));
        ...
        this.setState(() => {
            ...
            this.props.models.map((model, i) => {
                if (model.model_name.toString() === modelName.toString()) {
                    //dispatch an action here and update props
                    this.props.dispatch(change('addEditVehicleForm', 'model', model.model_name));
                    this.props.dispatch(change('addEditVehicleForm', 'model_id', model.model_id));
                }
            });
        });
    }
